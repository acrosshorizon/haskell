...
-- foldM _ b [] = pure b
-- foldM f b (a:as) = (`f` a) =<< foldM f b as
foldM f bs = foldl (\b a -> (`f` a) =<< b) (return bs)
...
-- | Rewrite /fmap/ using Monads (i.e. use bind). Not using (<$>) here due to name conflict
--
-- >>> (+1) <$> [1, 2, 3]
-- [2,3,4]
--
